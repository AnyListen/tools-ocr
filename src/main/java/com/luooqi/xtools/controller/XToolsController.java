...
import com.luooqi.xtools.ExtendedAnimatedFlowContainer;
...
@ViewController(value = "/fxml/XTools.fxml", title = "Material Design Example")
public class XToolsController {
    @FXMLViewFlowContext
